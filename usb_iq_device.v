...
(* top =  1  *)
(* generator = "Amaranth" *)
module usb_iq_device(ulpi_data_i, ulpi_dir, ulpi_nxt, rx_data, rx_valid, tx_ready, cmd_ready, resp_status, resp_rdata, resp_valid, clk, rst, usb_clk, usb_rst, ulpi_data_o, ulpi_data_oe, ulpi_stp, ulpi_rst, rx_ready, tx_data, tx_valid
, cmd_opcode, cmd_addr, cmd_wdata, cmd_valid, resp_ready, usb_connected, ulpi_clk);
  ...
  wire [31:0] cmd_addr;
  reg [3:0] cmd_count = 4'h0;
  output [7:0] cmd_opcode;
  wire [7:0] cmd_opcode;
  input cmd_ready;
  wire cmd_ready;
  reg [95:0] cmd_shift = 96'h000000000000000000000000;
  output cmd_valid;
  reg cmd_valid = 1'h0;
  (* init = 1'h0 *)
  wire cmd_valid_r;
  output [31:0] cmd_wdata;
  wire [31:0] cmd_wdata;
  wire connect;
  wire [7:0] data__i;
  wire [7:0] data__o;
  ...
  assign \$1  = ~ tx_valid;
  assign \ready$38  = tx_ready | \$1 ;
  assign \$2  = ~ cmd_valid;
  assign \ready$40  = cmd_ready | \$2 ;
  assign \$3  = tx_count + 1'h1;
  assign \$4  = tx_count == 3'h7;
  assign \$5  = cmd_count == 4'hb;
  assign \$6  = cmd_count + 1'h1;
  always @(posedge clk)
    tx_shift <= \$7 ;
  always @(posedge clk)
    tx_count <= \$8 ;
  ...
  \usb_iq_device.usb  usb (
    ...
    .op_mode(op_mode),
    .\payload$175 (rx_data),
    .\payload$215 (\payload$52 ),
    .\payload$232 (\payload$55 ),
    .\port$0$112 (resp_rdata),
    .\port$0$80 (resp_status),
    .\ready$173 (rx_ready),
    .\ready$216 (\ready$38 ),
    .\ready$233 (\ready$40 ),
    .\ready$235 (resp_ready),
    .\ready$86 (\tx_ready$62 ),
    .rx_active(rx_active),
    .rx_data(\rx_data$58 ),
    .rx_valid(\rx_valid$59 ),
  ...
  assign cmd_valid_r = cmd_valid;
  assign \payload$43  = { resp_rdata, resp_status };
  assign \valid$44  = resp_valid;
  assign \ready$45  = resp_ready;
  assign connect = 1'h1;
  ...
  assign cmd_opcode = cmd_shift[7:0];
  assign cmd_addr = cmd_shift[63:32];
  assign cmd_wdata = cmd_shift[95:64];
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb (\valid$174 , \port$0$80 , \port$0$112 , \valid$236 , usb_clk, usb_rst, \ready$216 , \ready$233 , session_end, term_select, \valid$214 , \payload$215 , \valid$231 , \payload$232 , tx_valid, rx_active, rx_data, rx_valid, line_state, \ready$86 , speed
, op_mode, \ready$173 , \ready$235 , tx_data, \payload$175 );
  ...
  wire [5:0] \clear_endpoint_halt_in$234 ;
  wire \clear_endpoint_halt_in$234.direction ;
  wire \clear_endpoint_halt_in$234.enable ;
  wire [3:0] \clear_endpoint_halt_in$234.number ;
  wire [5:0] \clear_endpoint_halt_in$239 ;
  wire \clear_endpoint_halt_in$239.direction ;
  wire \clear_endpoint_halt_in$239.enable ;
  wire [3:0] \clear_endpoint_halt_in$239.number ;
  ...
  wire [3:0] \endpoint$223 ;
  wire [3:0] \endpoint$238 ;
  wire first;
  wire \first$150 ;
  wire \first$179 ;
  wire \first$241 ;
  ...
  wire [7:0] \payload$220 ;
  output [7:0] \payload$232 ;
  wire [7:0] \payload$232 ;
  wire [63:0] \payload$237 ;
  wire [7:0] \payload$243 ;
  wire [7:0] \payload$55 ;
  wire [7:0] \payload$70 ;
  wire [7:0] \payload$71 ;
  wire [3:0] pid;
  ...
  wire [3:0] \pid$184 ;
  wire [3:0] \pid$246 ;
  input [31:0] \port$0$112 ;
  wire [31:0] \port$0$112 ;
  input [31:0] \port$0$80 ;
  wire [31:0] \port$0$80 ;
  wire ready;
  wire \ready$153 ;
  output \ready$173 ;
  ...
  wire \ready_for_response$229 ;
  wire \ready_for_response$249 ;
  ...
  \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920  USBMultibyteStreamInEndpoint_124707410239920 (
    .\ack$38 (ack),
    .address(\address$18 ),
    .clear_endpoint_halt_in(clear_endpoint_halt_in),
    .endpoint(endpoint),
    ...
    .new_token(new_token),
    .nyet(nyet),
    .\payload$22 (\payload$243 ),
    .pid(pid),
    .\port$0$112 (\port$0$112 ),
    .\port$0$80 (\port$0$80 ),
    .ready(\ready$235 ),
    .\ready$23 (ready),
    .ready_for_response(ready_for_response),
    .\stall$40 (stall),
    .tx_pid_toggle(\tx_pid_toggle$245 ),
    .usb_clk(usb_clk),
    .usb_rst(usb_rst),
    .\valid$13 (\valid$236 ),
    .\valid$19 (\valid$240 )
  ...
  \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552  USBStreamOutEndpoint_124707411861552 (
    .ack(\ack$226 ),
    .clear_endpoint_halt_in(clear_endpoint_halt_in),
    .complete_in(rx_complete),
    .endpoint(endpoint),
  ...
  \usb_iq_device.usb.endpoint_mux  endpoint_mux (
    ...
    .address(\address$18 ),
    .address_changed(\address_changed$161 ),
    .\address_changed$185 (address_changed),
    .clear_endpoint_halt_in(clear_endpoint_halt_in),
    .\clear_endpoint_halt_out$244 (clear_endpoint_halt_out),
    .config_changed(\config_changed$165 ),
    .\config_changed$197 (config_changed),
    .crc(crc),
    .endpoint(endpoint),
    .first(first),
    .\first$263 (\first$150 ),
    ...
    .nyet(nyet),
    .payload(payload),
    .\payload$210 (\payload$70 ),
    .\payload$265 (\payload$152 ),
    .\payload$269 (\payload$181 ),
    .\payload$273 (\payload$243 ),
    .pid(pid),
    .\port$2277$3 (active_pid[3]),
    .\port$2433$0 (\$8 ),
    .ready(ready),
    ...
    .\tx_pid_toggle$257 (\tx_pid_toggle$183 ),
    .\tx_pid_toggle$260 (\tx_pid_toggle$245 ),
    .tx_timeout(tx_timeout),
    .usb_clk(usb_clk),
    .usb_rst(usb_rst),
    .valid(valid),
  ...
  assign \valid$218  = valid;
  assign \next$219  = next;
  assign \payload$220  = payload;
  assign \rx_complete$221  = rx_complete;
  assign \rx_invalid$222  = rx_invalid;
  assign \endpoint$223  = endpoint;
  assign \is_out$224  = is_out;
  assign \rx_pid_toggle$225  = { 1'h0, active_pid[3] };
  assign \rx_ready_for_response$227  = rx_ready_for_response;
  assign \is_ping$228  = is_ping;
  assign \ready_for_response$229  = ready_for_response;
  assign \clear_endpoint_halt_in$234  = clear_endpoint_halt_in;
  assign \payload$237  = { \port$0$112 , \port$0$80  };
  assign \endpoint$238  = endpoint;
  assign \clear_endpoint_halt_in$239  = clear_endpoint_halt_in;
  assign \ready$244  = ready;
  assign \pid$246  = pid;
  assign \address$247  = \address$18 ;
  assign \new_token$248  = new_token;
  assign \ready_for_response$249  = ready_for_response;
  assign \frame$250  = frame;
  assign \new_frame$251  = new_frame;
  assign \is_in$252  = is_in;
  assign \is_out$253  = is_out;
  assign \is_setup$254  = is_setup;
  assign \is_ping$255  = is_ping;
  assign \ack$256  = 1'h0;
  assign \stall$258  = 1'h0;
  assign \ack$259  = ack;
  assign \nak$260  = nak;
  assign \stall$261  = stall;
  assign \nyet$262  = nyet;
  assign \ready$269  = \ready$86 ;
  assign \ready$270  = \ready$86 ;
  ...
  assign \clear_endpoint_halt_in$234.enable  = clear_endpoint_halt_in[0];
  assign \clear_endpoint_halt_in$234.direction  = clear_endpoint_halt_in[1];
  assign \clear_endpoint_halt_in$234.number  = clear_endpoint_halt_in[5:2];
  assign \clear_endpoint_halt_in$239.enable  = clear_endpoint_halt_in[0];
  assign \clear_endpoint_halt_in$239.direction  = clear_endpoint_halt_in[1];
  assign \clear_endpoint_halt_in$239.number  = clear_endpoint_halt_in[5:2];
...
module \usb_iq_device.usb.USBControlEndpoint.StandardRequestHandler.get_descriptor (usb_rst, value, \length$20 , ready, start, start_position, stall, valid, payload, first, last, usb_clk);
  ...
  initial begin
    ...
    rom[22] = 32'd33555199;
    rom[23] = 32'd117801730;
    rom[24] = 32'd1073807111;
    rom[25] = 32'd84083264;
    rom[26] = 32'd16711680;
    rom[27] = 32'd67307780;
    rom[28] = 32'd604194816;
    rom[29] = 32'd1627417600;
    rom[30] = 32'd1811970304;
    rom[31] = 32'd1660972800;
    rom[32] = 32'd1845501952;
    rom[33] = 32'd1442866432;
    rom[34] = 32'd1845523456;
    rom[35] = 32'd1962963456;
    rom[36] = 32'd1694528256;
    rom[37] = 32'd402871040;
    rom[38] = 32'd1879074048;
    rom[39] = 32'd1660974080;
    rom[40] = 32'd1912627456;
    rom[41] = 32'd536892160;
    rom[42] = 32'd1140871680;
    rom[43] = 32'd302198784;
    rom[44] = 32'd805318656;
    rom[45] = 32'd805318656;
    rom[46] = 32'd805318656;
    rom[47] = 32'd822083584;
  end
  reg [31:0] _0_;
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920 (\port$0$112 , \valid$13 , usb_clk, usb_rst, is_in, is_out, is_setup, is_ping, \payload$22 , new_frame, new_token, frame, pid, address, endpoint, ready_for_response, \ready$23 , \ack$38 , \nak$39 , \stall$40 , nyet
, clear_endpoint_halt_in, ready, tx_pid_toggle, \first$20 , nak, \valid$19 , \last$21 , \port$0$80 );
  ...
  always @(posedge usb_clk)
    fsm_state <= \$14 ;
  \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920.stream_ep  stream_ep (
    .\ack$60 (\ack$38 ),
    .address(address),
    .clear_endpoint_halt_in(clear_endpoint_halt_in),
    .endpoint(endpoint),
  ...
  assign payload = data_shift[7:0];
  assign \payload$14  = { \port$0$112 , \port$0$80  };
  assign \first$15  = 1'h0;
  assign \last$16  = 1'h0;
  assign ack = 1'h0;
  assign stall = 1'h0;
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920.stream_ep (usb_rst, is_in, is_out, is_setup, is_ping, \payload$25 , ready, new_frame, new_token, frame, pid, address, endpoint, ready_for_response, \ready$27 , \ack$60 , \nak$62 , \stall$64 , \nyet$66 , clear_endpoint_halt_in, valid
, first, last, payload, tx_pid_toggle, \first$21 , nak, \valid$19 , \last$23 , usb_clk);
  wire \$1 ;
  wire \$2 ;
  wire ack;
  ...
  assign reset_sequence = \$1  & \$2 ;
  \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920.stream_ep.tx_manager  tx_manager (
    .ack(\ack$60 ),
    .active(active),
    .data_pid(tx_pid_toggle),
    .first(\first$21 ),
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBMultibyteStreamInEndpoint_124707410239920.stream_ep.tx_manager (usb_rst, is_in, active, reset_sequence, \payload$34 , \ready$25 , new_token, ready_for_response, ready, ack, valid, last, payload, data_pid, first, nak, \valid$38 , \last$39 , usb_clk);
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBStreamOutEndpoint (usb_rst, read_en, is_out, is_ping, ack, nak, \valid$35 , \payload$37 , endpoint, ready_for_response, complete_in, invalid_in, \port$2277$3 , next, valid, payload, rx_ready_for_response, clear_endpoint_halt_in, usb_clk);
  ...
  assign \$7  = \$6  & is_out;
  assign \$8  = \port$2277$3  == expected_data_toggle;
  assign \$9  = \$7  & \$8 ;
  assign \$10  = \$9  & \next$21 ;
  ...
  assign \$26  = \$25  & is_out;
  assign \$27  = \port$2277$3  == expected_data_toggle;
  assign \$28  = \$26  & \$27 ;
  assign \$29  = endpoint == 2'h2;
  assign \$30  = \$29  & is_out;
  assign \$31  = \port$2277$3  == expected_data_toggle;
  assign \$32  = \$30  & \$31 ;
  assign \$33  = \$32  & \next$21 ;
  ...
  assign \$52  = \$51  & is_out;
  assign \$53  = \port$2277$3  == expected_data_toggle;
  assign \$54  = ~ \$53 ;
  assign \$55  = \$52  & \$54 ;
  assign \$56  = \$50  & \$55 ;
  assign ack = \$46  | \$56 ;
  ...
  assign \$62  = \$61  & is_out;
  assign \$63  = \port$2277$3  == expected_data_toggle;
  assign \$64  = \$62  & \$63 ;
  assign \$65  = endpoint == 2'h2;
  assign \$66  = \$65  & is_out;
  assign \$67  = \port$2277$3  == expected_data_toggle;
  assign \$68  = \$66  & \$67 ;
  assign \$69  = \$68  & \next$21 ;
  ...
  assign \$79  = \$78  & is_out;
  assign \$80  = \port$2277$3  == expected_data_toggle;
  assign \$81  = ~ \$80 ;
  assign \$82  = \$79  & \$81 ;
  assign \$83  = ~ \$82 ;
  assign \$84  = \$77  & \$83 ;
  ...
  assign \$94  = \$93  & is_out;
  assign \$95  = \port$2277$3  == expected_data_toggle;
  assign \$96  = \$94  & \$95 ;
  assign \$97  = \$96  & \next$21 ;
  ...
  assign \$107  = \port$2277$3  == expected_data_toggle;
  assign \$108  = \$106  & \$107 ;
  assign \$109  = endpoint == 2'h2;
  assign \$110  = \$109  & is_out;
  assign \$111  = \port$2277$3  == expected_data_toggle;
  assign \$112  = \$110  & \$111 ;
  assign \$113  = \$112  & \next$21 ;
  ...
  assign rx_pid_toggle = { 1'h0, \port$2277$3  };
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552 (usb_rst, read_en, is_out, is_ping, ack, nak, \valid$35 , \payload$37 , endpoint, ready_for_response, complete_in, invalid_in, \port$2277$3 , next, valid, payload, rx_ready_for_response, clear_endpoint_halt_in, usb_clk);
  ...
  assign \$12  = ~ full;
  assign write_en = \$11  & \$12 ;
  assign \$13  = endpoint == 2'h3;
  assign \$14  = \$13  & is_out;
  assign \$15  = \$14  & complete_out;
  assign \$16  = ~ overflow;
  assign write_commit = \$15  & \$16 ;
  assign \$17  = endpoint == 2'h3;
  assign \$18  = \$17  & is_out;
  assign \$19  = complete_out & overflow;
  assign \$20  = invalid_out | \$19 ;
  assign write_discard = \$18  & \$20 ;
  assign \$21  = endpoint == 2'h3;
  assign \$22  = \$21  & is_out;
  assign \$23  = \$22  & is_out;
  assign \$24  = \$23  & rx_ready_for_response;
  assign \$25  = endpoint == 2'h3;
  assign \$26  = \$25  & is_out;
  assign \$27  = \port$2277$3  == expected_data_toggle;
  assign \$28  = \$26  & \$27 ;
  assign \$29  = endpoint == 2'h3;
  assign \$30  = \$29  & is_out;
  assign \$31  = \port$2277$3  == expected_data_toggle;
  assign \$32  = \$30  & \$31 ;
  assign \$33  = \$32  & \next$21 ;
  ...
  assign \$39  = \$37  & \$38 ;
  assign \$40  = \$24  & \$39 ;
  assign \$41  = endpoint == 2'h3;
  assign \$42  = \$41  & is_ping;
  assign \$43  = \$42  & ready_for_response;
  assign \$44  = space_available >= 7'h40;
  assign \$45  = \$43  & \$44 ;
  assign \$46  = \$40  | \$45 ;
  assign \$47  = endpoint == 2'h3;
  assign \$48  = \$47  & is_out;
  assign \$49  = \$48  & is_out;
  assign \$50  = \$49  & rx_ready_for_response;
  assign \$51  = endpoint == 2'h3;
  assign \$52  = \$51  & is_out;
  assign \$53  = \port$2277$3  == expected_data_toggle;
  assign \$54  = ~ \$53 ;
  assign \$55  = \$52  & \$54 ;
  assign \$56  = \$50  & \$55 ;
  assign ack = \$46  | \$56 ;
  assign \$57  = endpoint == 2'h3;
  assign \$58  = \$57  & is_out;
  assign \$59  = \$58  & is_out;
  assign \$60  = \$59  & rx_ready_for_response;
  assign \$61  = endpoint == 2'h3;
  assign \$62  = \$61  & is_out;
  assign \$63  = \port$2277$3  == expected_data_toggle;
  assign \$64  = \$62  & \$63 ;
  assign \$65  = endpoint == 2'h3;
  assign \$66  = \$65  & is_out;
  assign \$67  = \port$2277$3  == expected_data_toggle;
  assign \$68  = \$66  & \$67 ;
  assign \$69  = \$68  & \next$21 ;
  ...
  assign \$99  = \$98  & full;
  assign \$100  = write_commit | write_discard;
  assign \$101  = endpoint == 2'h3;
  assign \$102  = \$101  & is_out;
  assign \$103  = \$102  & is_out;
  assign \$104  = \$103  & rx_ready_for_response;
  assign \$105  = endpoint == 2'h3;
  assign \$106  = \$105  & is_out;
  assign \$107  = \port$2277$3  == expected_data_toggle;
  assign \$108  = \$106  & \$107 ;
  assign \$109  = endpoint == 2'h3;
  assign \$110  = \$109  & is_out;
  assign \$111  = \port$2277$3  == expected_data_toggle;
  assign \$112  = \$110  & \$111 ;
  assign \$113  = \$112  & \next$21 ;
  ...
  assign \$122  = ~ clear_endpoint_halt_in[1];
  assign \$123  = clear_endpoint_halt_in[0] & \$122 ;
  assign \$124  = clear_endpoint_halt_in[5:2] == 2'h3;
  assign \$125  = \$123  & \$124 ;
  always @(posedge usb_clk)
    rx_cnt <= \$126 ;
  always @(posedge usb_clk)
  ...
  always @(posedge usb_clk)
    expected_data_toggle <= \$129 ;
  \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552.boundary_detector  boundary_detector (
    .complete_in(complete_in),
    .complete_out(complete_out),
    .first(first),
    .invalid_in(invalid_in),
  ...
  \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552.fifo  fifo (
    .empty(empty),
    .full(full),
    .read_data(read_data),
    .read_en(read_en),
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552.boundary_detector (usb_rst, complete_in, invalid_in, \next$12 , \valid$11 , payload, valid, first, last, next, complete_out, invalid_out, \payload$18 , usb_clk);
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.USBStreamOutEndpoint_124707411861552.fifo (usb_rst, read_en, write_en, write_commit, write_discard, empty, full, read_data, write_port__data, space_available, usb_clk);
  ...
  assign \$1  = ~ full;
  assign write_port__en = write_en & \$1 ;
  assign \$2  = write_port__addr == 7'h40;
  assign \$3  = write_port__addr + 1'h1;
  assign \$4  = current_read_pointer == 7'h40;
  assign \$5  = current_read_pointer + 1'h1;
  assign \$6  = ~ empty;
  assign \$7  = read_en & \$6 ;
  assign empty = current_read_pointer == committed_write_pointer;
  assign \$8  = committed_read_pointer <= write_port__addr;
  assign \$9  = write_port__addr - committed_read_pointer;
  assign \$10  = $signed(8'h40) - $signed(\$9 );
  assign \$11  = committed_read_pointer - write_port__addr;
  assign \$12  = $signed(\$11 ) - $signed(2'h1);
  assign full = next_write_pointer == committed_read_pointer;
  assign \$13  = ~ full;
...
(* generator = "Amaranth" *)
module \usb_iq_device.usb.endpoint_mux (usb_rst, is_in, is_out, is_setup, is_ping, crc, \ack$214 , \nak$220 , \stall$226 , start, \start$238 , \valid$204 , first, last, \payload$269 , \ack$217 , \nak$223 , \ack$218 , \nak$224 , \payload$273 , active_address
, active_config, speed, new_frame, new_token, frame, pid, address, endpoint, ready_for_response, ready, rx_complete, rx_invalid, \port$2277$3 , next, valid, payload, rx_ready_for_response, ack, nak, stall, nyet
, tx_allowed, tx_timeout, rx_timeout, \address_changed$185 , new_address, \config_changed$197 , new_config, clear_endpoint_halt_in, tx_pid_toggle, \payload$210 , \ack$215 , \start$239 , \start$233 , \valid$249 , \first$263 , \last$264 , \payload$265 , \port$2433$0 , \nak$221 , \stall$227 , address_changed
, \new_address$187 , config_changed, \new_config$199 , \clear_endpoint_halt_out$244 , \tx_pid_toggle$257 , \first$267 , \nak$222 , \valid$251 , \last$268 , \tx_pid_toggle$260 , \first$271 , \nak$225 , \valid$254 , \last$272 , usb_clk);
  ...
  wire \address_changed$182 ;
  wire \address_changed$183 ;
  wire \address_changed$184 ;
  output \address_changed$185 ;
  reg \address_changed$185 ;
  ...
  wire [5:0] \clear_endpoint_halt_in$169 ;
  wire \clear_endpoint_halt_in$169.direction ;
  wire \clear_endpoint_halt_in$169.enable ;
  wire [3:0] \clear_endpoint_halt_in$169.number ;
  ...
  wire [3:0] \clear_endpoint_halt_in.number ;
  wire [5:0] clear_endpoint_halt_out;
  input [5:0] \clear_endpoint_halt_out$244 ;
  wire [5:0] \clear_endpoint_halt_out$244 ;
  wire \clear_endpoint_halt_out$244.direction ;
  wire \clear_endpoint_halt_out$244.enable ;
  wire [3:0] \clear_endpoint_halt_out$244.number ;
  wire [5:0] \clear_endpoint_halt_out$245 ;
  wire \clear_endpoint_halt_out$245.direction ;
  wire \clear_endpoint_halt_out$245.enable ;
  wire [3:0] \clear_endpoint_halt_out$245.number ;
  wire [5:0] \clear_endpoint_halt_out$246 ;
  wire \clear_endpoint_halt_out$246.direction ;
  wire \clear_endpoint_halt_out$246.enable ;
  wire [3:0] \clear_endpoint_halt_out$246.number ;
  wire [5:0] \clear_endpoint_halt_out$247 ;
  wire \clear_endpoint_halt_out$247.direction ;
  wire \clear_endpoint_halt_out$247.enable ;
  wire [3:0] \clear_endpoint_halt_out$247.number ;
  wire [5:0] \clear_endpoint_halt_out$248 ;
  wire \clear_endpoint_halt_out$248.direction ;
  wire \clear_endpoint_halt_out$248.enable ;
  wire [3:0] \clear_endpoint_halt_out$248.number ;
  wire \clear_endpoint_halt_out.direction ;
  wire \clear_endpoint_halt_out.enable ;
  wire [3:0] \clear_endpoint_halt_out.number ;
  input config_changed;
  wire config_changed;
  wire \config_changed$193 ;
  wire \config_changed$194 ;
  wire \config_changed$195 ;
  wire \config_changed$196 ;
  output \config_changed$197 ;
  reg \config_changed$197 ;
  input [15:0] crc;
  wire [15:0] crc;
  wire [15:0] \crc$1 ;
  wire [15:0] \crc$120 ;
  ...
  wire \nyet$67 ;
  wire \nyet$97 ;
  reg [4:0] past_valid = 5'h00;
  input [7:0] payload;
  wire [7:0] payload;
  wire [7:0] \payload$112 ;
  wire [7:0] \payload$142 ;
  wire [7:0] \payload$172 ;
  output [7:0] \payload$210 ;
  wire [7:0] \payload$210 ;
  wire [7:0] \payload$211 ;
  input [7:0] \payload$265 ;
  wire [7:0] \payload$265 ;
  input [7:0] \payload$269 ;
  wire [7:0] \payload$269 ;
  input [7:0] \payload$273 ;
  wire [7:0] \payload$273 ;
  wire [7:0] \payload$45 ;
  wire [7:0] \payload$82 ;
  input [3:0] pid;
  wire [3:0] pid;
  ...
  wire \rx_ready_for_response$174 ;
  ...
  wire [1:0] \tx_pid_toggle$256 ;
  input [1:0] \tx_pid_toggle$257 ;
  wire [1:0] \tx_pid_toggle$257 ;
  wire [1:0] \tx_pid_toggle$258 ;
  wire [1:0] \tx_pid_toggle$259 ;
  input [1:0] \tx_pid_toggle$260 ;
  wire [1:0] \tx_pid_toggle$260 ;
  input tx_timeout;
  wire tx_timeout;
  wire \tx_timeout$122 ;
  wire \tx_timeout$152 ;
  ...
  assign \$8  = \$7  | \nak$224 ;
  assign \nak$220  = \$8  | \nak$225 ;
  assign \$36  = \valid$249  | past_valid[0];
  assign \$37  = \valid$251  | past_valid[1];
  assign \$40  = \valid$254  | past_valid[4];
  always @(posedge usb_clk)
    past_valid <= \$41 ;
  \usb_iq_device.usb.endpoint_mux.tx_mux  tx_mux (
    ...
    .\last$25 (\last$272 ),
    .payload(\payload$210 ),
    .\payload$12 (\payload$273 ),
    .\payload$8 (\payload$265 ),
    .\payload$9 (\payload$269 ),
    .ready(ready),
    .valid(\valid$249 ),
    .\valid$13 (\valid$204 ),
    .\valid$2 (\valid$251 ),
  ...
  always @* begin
    ...
    tx_pid_toggle = 2'h0;
    if (\$36 ) begin
      tx_pid_toggle = { 1'h0, \port$2433$0  };
    end else if (\$37 ) begin
      tx_pid_toggle = \tx_pid_toggle$257 ;
    end else if (\$38 ) begin
      tx_pid_toggle = 2'h0;
    end else if (\$39 ) begin
      tx_pid_toggle = 2'h0;
    end else if (\$40 ) begin
      tx_pid_toggle = \tx_pid_toggle$260 ;
    end
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2355:dump_module$28 ) begin end
    \$41  = { \valid$254 , 2'h0, \valid$251 , \valid$249  };
    if (usb_rst) begin
      \$41  = 5'h00;
    end
  end
  ...
  assign rx_pid_toggle = { 1'h0, \port$2277$3  };
  assign \rx_pid_toggle$53  = { 1'h0, \port$2277$3  };
  ...
  assign \rx_pid_toggle$86  = { 1'h0, \port$2277$3  };
  ...
  assign \rx_pid_toggle$116  = { 1'h0, \port$2277$3  };
  ...
  assign \rx_pid_toggle$146  = { 1'h0, \port$2277$3  };
  assign \speed$147  = speed;
  assign \active_config$148  = active_config;
  assign \active_address$149  = active_address;
  assign \crc$150  = crc;
  assign \tx_allowed$151  = tx_allowed;
  assign \tx_timeout$152  = tx_timeout;
  assign \rx_timeout$153  = rx_timeout;
  assign \ack$154  = ack;
  assign \nak$155  = nak;
  assign \stall$156  = stall;
  assign \nyet$157  = nyet;
  assign \pid$158  = pid;
  assign \address$159  = address;
  assign \endpoint$160  = endpoint;
  assign \new_token$161  = new_token;
  assign \ready_for_response$162  = ready_for_response;
  assign \frame$163  = frame;
  assign \new_frame$164  = new_frame;
  assign \is_in$165  = is_in;
  assign \is_out$166  = is_out;
  assign \is_setup$167  = is_setup;
  assign \is_ping$168  = is_ping;
  assign \clear_endpoint_halt_in$169  = clear_endpoint_halt_in;
  assign \valid$170  = valid;
  assign \next$171  = next;
  assign \payload$172  = payload;
  assign \rx_complete$173  = rx_complete;
  assign \rx_ready_for_response$174  = rx_ready_for_response;
  assign \rx_invalid$175  = rx_invalid;
  assign \rx_pid_toggle$176  = { 1'h0, \port$2277$3  };
  assign \speed$177  = speed;
  assign \active_config$178  = active_config;
  assign \active_address$179  = active_address;
  assign \address_changed$181  = 1'h0;
  assign \address_changed$182  = 1'h0;
  assign \address_changed$183  = 1'h0;
  assign \address_changed$184  = 1'h0;
  assign \new_address$188  = 7'h00;
  assign \new_address$189  = 7'h00;
  assign \new_address$190  = 7'h00;
  assign \new_address$191  = 7'h00;
  assign \config_changed$193  = 1'h0;
  assign \config_changed$194  = 1'h0;
  assign \config_changed$195  = 1'h0;
  assign \config_changed$196  = 1'h0;
  assign \new_config$200  = 8'h00;
  assign \new_config$201  = 8'h00;
  assign \new_config$202  = 8'h00;
  assign \new_config$203  = 8'h00;
  assign \valid$205  = \valid$204 ;
  assign \first$207  = first;
  assign \last$209  = last;
  assign \payload$211  = \payload$210 ;
  assign \ready$213  = ready;
  assign \ack$216  = 1'h0;
  assign \ack$219  = 1'h0;
  assign \stall$228  = 1'h0;
  assign \stall$229  = 1'h0;
  assign \stall$230  = 1'h0;
  assign \stall$231  = 1'h0;
  assign \start$234  = 1'h0;
  assign \start$235  = 1'h0;
  assign \start$236  = 1'h0;
  assign \start$237  = 1'h0;
  assign \start$240  = 1'h0;
  assign \start$241  = 1'h0;
  assign \start$242  = 1'h0;
  assign \start$243  = 1'h0;
  assign \clear_endpoint_halt_out$245  = 6'h00;
  assign \clear_endpoint_halt_out$246  = 6'h00;
  assign \clear_endpoint_halt_out$247  = 6'h00;
  assign \clear_endpoint_halt_out$248  = 6'h00;
  assign \valid$252  = 1'h0;
  assign \valid$253  = 1'h0;
  assign \tx_pid_toggle$256  = { 1'h0, \port$2433$0  };
  assign \tx_pid_toggle$258  = 2'h0;
  assign \tx_pid_toggle$259  = 2'h0;
  assign \ready$266  = ready;
  assign \ready$270  = ready;
  assign \ready$274  = ready;
  assign \clear_endpoint_halt_in.enable  = clear_endpoint_halt_in[0];
  assign \clear_endpoint_halt_in.direction  = clear_endpoint_halt_in[1];
  assign \clear_endpoint_halt_in.number  = clear_endpoint_halt_in[5:2];
  ...
  assign \clear_endpoint_halt_in$169.enable  = clear_endpoint_halt_in[0];
  assign \clear_endpoint_halt_in$169.direction  = clear_endpoint_halt_in[1];
  assign \clear_endpoint_halt_in$169.number  = clear_endpoint_halt_in[5:2];
  assign \clear_endpoint_halt_out$244.enable  = \clear_endpoint_halt_out$244 [0];
  assign \clear_endpoint_halt_out$244.direction  = \clear_endpoint_halt_out$244 [1];
  assign \clear_endpoint_halt_out$244.number  = \clear_endpoint_halt_out$244 [5:2];
  assign \clear_endpoint_halt_out$245.enable  = 1'h0;
  assign \clear_endpoint_halt_out$245.direction  = 1'h0;
  assign \clear_endpoint_halt_out$245.number  = 4'h0;
  assign \clear_endpoint_halt_out$246.enable  = 1'h0;
  assign \clear_endpoint_halt_out$246.direction  = 1'h0;
  assign \clear_endpoint_halt_out$246.number  = 4'h0;
  assign \clear_endpoint_halt_out$247.enable  = 1'h0;
  assign \clear_endpoint_halt_out$247.direction  = 1'h0;
  assign \clear_endpoint_halt_out$247.number  = 4'h0;
  assign \clear_endpoint_halt_out$248.enable  = 1'h0;
  assign \clear_endpoint_halt_out$248.direction  = 1'h0;
  assign \clear_endpoint_halt_out$248.number  = 4'h0;
  assign clear_endpoint_halt_in[5:2] = \$35 ;
  assign clear_endpoint_halt_in[1] = \$30 ;
  assign clear_endpoint_halt_in[0] = \$25 ;
  assign \$1  = \ack$215 ;
  assign \$2  = \ack$215 ;
  assign \ack$214  = \$4 ;
  assign \$5  = \nak$221 ;
  ...
  assign \$11  = \stall$227 ;
  assign \$12  = \stall$227 ;
  assign \stall$226  = \stall$227 ;
  assign \$13  = \start$233 ;
  assign \$14  = \start$233 ;
  assign \$15  = \start$233 ;
  assign \$16  = \start$233 ;
  assign \$31  = \clear_endpoint_halt_out$244 [5:2];
  assign \$32  = \clear_endpoint_halt_out$244 [5:2];
  assign \$33  = \clear_endpoint_halt_out$244 [5:2];
  assign \$34  = \clear_endpoint_halt_out$244 [5:2];
  assign \$35  = \clear_endpoint_halt_out$244 [5:2];
  assign start = \start$233 ;
  assign \$17  = \start$239 ;
  assign \$18  = \start$239 ;
  assign \$19  = \start$239 ;
  assign \$20  = \start$239 ;
  assign \start$238  = \start$239 ;
  assign \$21  = \clear_endpoint_halt_out$244 [0];
  assign \$22  = \clear_endpoint_halt_out$244 [0];
  assign \$23  = \clear_endpoint_halt_out$244 [0];
  assign \$24  = \clear_endpoint_halt_out$244 [0];
  assign \$25  = \clear_endpoint_halt_out$244 [0];
  assign \$26  = \clear_endpoint_halt_out$244 [1];
  assign \$27  = \clear_endpoint_halt_out$244 [1];
  assign \$28  = \clear_endpoint_halt_out$244 [1];
  assign \$29  = \clear_endpoint_halt_out$244 [1];
  assign \$30  = \clear_endpoint_halt_out$244 [1];
  assign \$38  = past_valid[2];
  assign \$39  = past_valid[3];
endmodule

(* generator = "Amaranth" *)
module \usb_iq_device.usb.endpoint_mux.tx_mux (first, last, \payload$9 , \payload$12 , ready, payload, valid, \first$15 , \last$21 , \payload$8 , \first$16 , \valid$2 , \last$22 , \first$19 , \valid$5 , \last$25 , \valid$13 );
  ...
  wire \valid$5 ;
  assign \$2  = \$1  | \valid$2 ;
  assign \valid$13  = \$4  | \valid$5 ;
  assign \$6  = \$5  | \first$16 ;
  assign first = \$8  | \first$19 ;
  assign \$10  = \$9  | \last$22 ;
  assign last = \$12  | \last$25 ;
  ...
  assign \payload$11  = 8'h00;
  assign \first$17  = 1'h0;
  assign \first$18  = 1'h0;
  assign \last$23  = 1'h0;
  assign \last$24  = 1'h0;
  assign \ready$27  = ready;
  assign \ready$28  = ready;
  assign \ready$29  = ready;
  assign \ready$30  = ready;
  assign \ready$31  = ready;
  assign i[4] = \valid$5 ;
  assign i[3] = 1'h0;
  assign i[2] = 1'h0;
  assign i[1] = \valid$2 ;
